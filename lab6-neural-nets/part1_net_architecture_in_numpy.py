...
def zad2_two_layer_net(student_id):
    ...
    # model.hidden_layer.W[:, 0] = [1, 1]  # wagi dla neuronu h1
    # # model.hidden_layer.W[:, 0] = [0, 1]  # wagi dla neuronu h1
    # model.hidden_layer.W[:, 1] = [-1, 1]  # wagi dla neuronu h2
    # model.hidden_layer.b[:] = [-0.5, 0.5]  # biasy dla neuronów h1 i h2
    #
    # model.output_layer.W[:, 0] = [1, -1]  # wagi dla neuronu wyjściowego
    # model.output_layer.b[:] = [-0.5]  # bias dla neuronu wyjściowego
    ...
    # model.hidden_layer.W[:, 0] = [1, -0.2]  # wagi dla neuronu h1
    # model.hidden_layer.W[:, 1] = [-1, 0.11]  # wagi dla neuronu h2
    # model.hidden_layer.b[:] = [0, 0.8]  # biasy dla neuronów h1 i h2
    #
    # model.output_layer.W[:, 0] = [1, -1]  # wagi dla neuronu wyjściowego
    # model.output_layer.b[:] = [-0.8]  # bias dla neuronu wyjściowego
...
if __name__ == '__main__':
    ...
    # visualize_activation_function(sigmoid)
    # visualize_activation_function(hardlim)
    # visualize_activation_function(linear)
